;;; doom-darkest-night-theme.el
(require 'doom-themes)

(defgroup doom-darkest-night-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-darkest-night-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-darkest-night-theme
  :type '(or integer boolean))

(def-doom-theme doom-darkest-night
  ...
  ((bg         '("#000000" nil       nil          ))
   ...
   (-modeline-pad
    (when doom-darkest-night-padded-modeline
      (if (integerp doom-darkest-night-padded-modeline)
          doom-darkest-night-padded-modeline
        4))))
...
(provide 'doom-darkest-night-theme)
;;; doom-darkest-night-theme.el ends here
