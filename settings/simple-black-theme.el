;;; simple-black.el --- Port of simple-black theme

;; based on https://github.com/jmdeldin/ir-black-theme.el

(deftheme simple-black "blank is the new black")
...
(let ((*background-color*   "#000000")
  ...
  (custom-theme-set-faces
   ...
   `(linum ((t (:background, *line-number*, :foreground, *dark-gray*))))
